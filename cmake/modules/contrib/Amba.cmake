...
if (USE_AMBA_TOOLCHAIN)
    ...
    set(CMAKE_FIND_ROOT_PATH /usr/aarch64-linux-gnu/libc CACHE PATH "CMake Find Root Path" FORCE)
    set(CMAKE_LINKER /usr/bin/aarch64-linux-gnu-ld CACHE FILEPATH "Path to a program." FORCE)
    set(CMAKE_AR /usr/bin/aarch64-linux-gnu-ar CACHE FILEPATH "Path to a program." FORCE)
    set(CMAKE_NM /usr/bin/aarch64-linux-gnu-nm CACHE FILEPATH "Path to a program." FORCE)
    set(CMAKE_OBJCOPY /usr/bin/aarch64-linux-gnu-objcopy CACHE FILEPATH "Path to a program." FORCE)
    set(CMAKE_OBJDUMP /usr/bin/aarch64-linux-gnu-objdump CACHE FILEPATH "Path to a program." FORCE)
    set(CMAKE_RANLIB /usr/bin/aarch64-linux-gnu-ranlib CACHE FILEPATH "Path to a program." FORCE)
    set(CMAKE_STRIP /usr/bin/aarch64-linux-gnu-strip CACHE FILEPATH "Path to a program." FORCE)
endif()
