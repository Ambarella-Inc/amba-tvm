...
InferCorrectLayoutOutput MlasMatmulInferCorrectLayout(const Attrs& attrs,
...
- **out**: `(b, m, n)` or `(m, n)`.
    ...
    .set_attr<FInferCorrectLayout>("FInferCorrectLayout", MlasMatmulInferCorrectLayout);
...
InferCorrectLayoutOutput MlasPackbInferCorrectLayout(const Attrs& attrs,
                                                 const Array<Layout>& new_in_layouts,
                                                 const Array<Layout>& old_in_layouts,
                                                 const Array<tvm::relay::Type>& old_in_types) {
  return InferCorrectLayoutOutput({"NC"}, {"NC"}, attrs);
}
...
RELAY_REGISTER_OP("mlas_packb")
    ...
    .set_attr<FInferCorrectLayout>("FInferCorrectLayout", MlasPackbInferCorrectLayout);
